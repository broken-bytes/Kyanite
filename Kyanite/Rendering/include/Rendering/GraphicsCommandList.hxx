...
#pragma region PUBLIC
        ...
        virtual auto ClearRenderTarget(std::shared_ptr<DescriptorHandle> target, glm::vec4 color) -> void = 0;
		virtual auto ClearDepthTarget(std::shared_ptr<DescriptorHandle> target, float depth = 1.0) -> void = 0;
